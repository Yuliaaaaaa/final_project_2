    ...
    <ul class="table-fill">
        ...
        <c:forEach items="${editions}" var="edition" varStatus="loop">
            ...
            <div name="details" style="display: none; width: 100%; background-color: cornsilk">
                ...
                <input onchange="countSum(${loop.index})" type="number" step="1" min="1" max="99" name="issues" style="width: 35px">
                ...
                <button name="pay" value="true" style="float: right; margin: 0px 7px 7px"
                        onclick="this.form.submit()">
                    <fmt:message key="label.subscribe.pay"/></button>
                <button name="cart" value="true" style="float: right" onclick="this.form.submit()">
